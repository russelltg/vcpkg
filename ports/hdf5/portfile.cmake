...
vcpkg_from_github(
    ...
    PATCHES
        ...
        prebuilt_settings.patch
        proper_pregen_stamp.patch
)
...
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "iOS")
    list(APPEND TRY_RUN_OPTIONS
        -DH5_PRINTF_LL_TEST_RUN=TRUE
        -DH5_PRINTF_LL_TEST_RUN__TRYRUN_OUTPUT="PRINTF_LL_WIDTH=[%ll]"
        -DRUN_RESULT_VAR=TRUE
        -DRUN_RESULT_VAR__TRYRUN_OUTPUT="15\\\\;0\\\\;"
        ...
        # -DHDF5_BATCH_H5DETECT
        -DHDF5_USE_PREGEN=ON
        -DHDF5_USE_PREGEN_DIR=${SOURCE_PATH}/src
    )

    file(COPY_FILE ${CMAKE_CURRENT_LIST_DIR}/H5Tinit_iOS.c ${SOURCE_PATH}/src/H5Tinit.c)
    file(COPY_FILE ${CMAKE_CURRENT_LIST_DIR}/H5lib_settings_iOS.c ${SOURCE_PATH}/src/H5lib_settings.c)
endif()
